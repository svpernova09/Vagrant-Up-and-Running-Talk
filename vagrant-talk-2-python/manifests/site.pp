...
$user = 'svper' # User to create
$password = 'vagrant' # The user's password
$project = 'SvpernovaDjango' # Used in nginx and uwsgi
$domain_name = 'svperdjango.com' # Used in nginx, uwsgi and virtualenv directory
$db_name = 'svperdjango' # Mysql database name to create
